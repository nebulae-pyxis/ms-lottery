...
![Intro](docs/images/ms-lottery_intro.png "Intro")
# Table of Contents
  ...
  * [BackEnd](#backend)
    *  [lottery](#backend_lottery)
        * [Environment variables](#backend_lottery_env_vars)
        * [Event Sourcing](#backend_lottery_eventsourcing)
        * [CronJobs](#backend_lottery_cronjobs)
...
│   ├── lottery                     => Micro-BackEnd responsible for ...
...
Note: You may find the GraphQL schema [here](api/emi-gateway/graphql/lottery/schema.gql)
...
## lottery <a name="backend_lottery"></a>
...


### Environment variables <a name="backend_lottery_env_vars"></a>
...
```
#### Notes: 
  * ENV VARS for development are [here](backend/lottery/.env)
  * ENV VARS for production are [here](deployment/gke/deployment-lottery.yaml)

### Event Sourcing <a name="backend_lottery_eventsourcing"></a>
...
### CronJobs <a name="backend_lottery_cronjobs"></a>
...
### 1. clone this repo  
   ```git clone https://github.com/nebulae-pyxis/ms-lottery.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://github.com/nebulae-pyxis/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-lottery/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-lottery/etc/mfe-setup.json
```

### 6. Compose the API emi-gateway
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-pyxis/emi-gateway --api-id=emi-gateway --output-dir=FULL_PATH_TO_REPO/ms-lottery/playground/emi-gateway  --setup-file=FULL_PATH_TO_REPO/ms-lottery/etc/mapi-setup.json
```
...
* set this key value to the **JWT_PUBLIC_KEY** atribute in the following files: *WORKING_FOLDER*/ms-lottery/backend/lottery/.env   *WORKING_FOLDER*/ms-lottery/playground/emi-gateway/.env  
